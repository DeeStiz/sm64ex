...
int main(void){uint64_t f=OFFSET;f=row(f,0,1,356,UINT32_C(0x3f99999a),150,0);f=row(f,0,22,0,UINT32_C(0x3f99999a),150,1);printf("vanishCapFingerprint=0x%016llx\n",(unsigned long long)f);puts("SM64 Modern vanish cap C contract passed");return 0;}
