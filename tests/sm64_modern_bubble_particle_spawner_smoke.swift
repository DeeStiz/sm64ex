...
@main
struct SM64BubbleParticleSpawnerSmoke {
    static func main() {
        ...
        print(String(format: "bubbleParticleSpawnerFingerprint=0x%016llx", fingerprint))
        print("SM64 Modern bubble particle spawner smoke passed")
    }
}
