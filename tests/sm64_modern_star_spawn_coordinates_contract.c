...
int main(void) {
    ...
    fingerprint = hash_float(fingerprint, 1.0f);
    fingerprint = hash_float(fingerprint, 1.0f);
    fingerprint = hash_u64(fingerprint, UINT64_C(0x1000));
    fingerprint = hash_float(fingerprint, 1.0f);
    fingerprint = hash_float(fingerprint, 2.0f);
    ...
    fingerprint = hash_u64(fingerprint, UINT64_C(1));
    fingerprint = hash_u64(fingerprint, UINT64_C(1));
    printf("starSpawnCoordinatesFingerprint=0x%016llx\n", (unsigned long long) fingerprint);
    puts("SM64 Modern star-spawn coordinates C contract passed");
    return 0;
}
