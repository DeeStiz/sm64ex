    ...
    static func main() throws {
        ...
        let records = [
            SM64SaveReplayRecord(
                ...
                mutationFlags: 0x40, mutationCourseIndex: UInt32.max,
                mutationStarFlags: -1, mutationLevel: 0, mutationArea: 0,
                mutationCapX: 0, mutationCapY: 0, mutationCapZ: 0,
                mutationSoundMode: 0,
            ...
            SM64SaveReplayRecord(
                ...
                mutationOperation: 0, sourceFileIndex: UInt32.max,
                mutationFlags: 0, mutationCourseIndex: UInt32.max,
                mutationStarFlags: -1, mutationLevel: 0, mutationArea: 0,
                mutationCapX: 0, mutationCapY: 0, mutationCapZ: 0,
                mutationSoundMode: 0,
