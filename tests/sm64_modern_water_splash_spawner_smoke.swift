...
struct SM64WaterSplashSpawnerSmoke {
    static func main() {
        ...
        print(String(format: "waterSplashSpawnerFingerprint=0x%016llx", fingerprint))
        print("SM64 Modern water splash spawner smoke passed")
    }
}
