...
int main(void) {
    ...
    fingerprint = hash_u64(fingerprint, UINT64_C(0x41b80000));
    fingerprint = hash_u64(fingerprint, UINT64_C(0));
    fingerprint = hash_u64(fingerprint, UINT64_C(0x40400000));
    fingerprint = hash_u64(fingerprint, UINT64_C(0));
    fingerprint = hash_u64(fingerprint, UINT64_C(0));
    printf("whitePuffSmoke2Fingerprint=0x%016llx\n", (unsigned long long)fingerprint);
    puts("SM64 Modern white puff smoke 2 C contract passed");
    return 0;
}
