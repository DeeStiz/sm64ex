...
int main(void) {
    ...
    fingerprint = hash_u64(fingerprint, 8000);
    fingerprint = hash_u64(fingerprint, 60);
    fingerprint = hash_u64(fingerprint, 1);
    fingerprint = hash_u64(fingerprint, 2);
    fingerprint = hash_u64(fingerprint, 16000);
    fingerprint = hash_u64(fingerprint, 0);
    fingerprint = hash_u64(fingerprint, 0);
    printf("whirlpoolFingerprint=0x%016llx\n", (unsigned long long)fingerprint);
    puts("SM64 Modern whirlpool C contract passed");
    return 0;
}
