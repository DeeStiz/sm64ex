...
int main(void) {
    ...
    fingerprint = hash_u64(fingerprint, UINT64_C(0x6464645F777031));
    fingerprint = hash_float(fingerprint, 30000.0f);
    fingerprint = hash_u64(fingerprint, UINT64_C(1));
    fingerprint = hash_u64(fingerprint, UINT64_C(0x6464645F777032));
    fingerprint = hash_float(fingerprint, 30000.0f);
    fingerprint = hash_u64(fingerprint, UINT64_C(1));
    printf("dddWarpFingerprint=0x%016llx\n", (unsigned long long) fingerprint);
    puts("SM64 Modern DDD warp C contract passed");
    return 0;
}
