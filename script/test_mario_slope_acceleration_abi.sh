...
BUILD_ROOT="$PROJECT_ROOT/build/sm64-modern-mario-slope-acceleration-abi-smoke"
...
xcrun swiftc \
  ...
  "$PROJECT_ROOT/tests/sm64_modern_mario_slope_acceleration_abi_smoke.swift" \
  "$BUILD_ROOT/sm64_modern_mario_slope_acceleration_migration.o" \
  "$BUILD_ROOT/sm64_modern_mario_action_authority_stub.o" \
  -o "$BUILD_ROOT/sm64-modern-mario-slope-acceleration-abi-smoke"

"$BUILD_ROOT/sm64-modern-mario-slope-acceleration-abi-smoke"
