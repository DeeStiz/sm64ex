...
BUILD_ROOT="$PROJECT_ROOT/build/sm64-modern-mario-terrain-abi-smoke"
...
xcrun clang -std=c11 -DNON_MATCHING=1 -DAVOID_UB=1 -D_LANGUAGE_C -DVERSION_US \
  ...
  -c "$PROJECT_ROOT/src/pc/sm64_modern_mario_terrain_migration.c" \
  -o "$BUILD_ROOT/sm64_modern_mario_terrain_migration.o"
xcrun clang -std=c11 -DNON_MATCHING=1 -DAVOID_UB=1 -D_LANGUAGE_C -DVERSION_US \
  -I"$PROJECT_ROOT/include" -I"$PROJECT_ROOT/src" -I"$PROJECT_ROOT/src/pc" \
...
xcrun swiftc \
  ...
  "$PROJECT_ROOT/tests/sm64_modern_mario_terrain_abi_smoke.swift" \
  "$BUILD_ROOT/sm64_modern_mario_terrain_migration.o" \
  "$BUILD_ROOT/sm64_modern_mario_action_authority_stub.o" \
  -o "$BUILD_ROOT/sm64-modern-mario-terrain-abi-smoke"

"$BUILD_ROOT/sm64-modern-mario-terrain-abi-smoke"
