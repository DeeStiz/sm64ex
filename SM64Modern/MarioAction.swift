...
enum SM64MarioActionID {
    ...
    static let groundPound: UInt32 = 0x008008A9
    static let airThrow: UInt32 = 0x830008AB
    static let airThrowLand: UInt32 = 0x80000A36
    static let headStuckInGround: UInt32 = 0x0002033A
    static let diveSlide: UInt32 = 0x00880456
    static let twirlLand: UInt32 = 0x18800238
    static let lavaBoostLand: UInt32 = 0x08000239
    ...
    static let holdWaterActionEnd: UInt32 = 0x300022C3
    static let drowning: UInt32 = 0x300032C4
    static let backwardWaterKnockback: UInt32 = 0x300222C5
    static let forwardWaterKnockback: UInt32 = 0x300222C6
    static let waterDeath: UInt32 = 0x300032C7
    static let waterShocked: UInt32 = 0x300222C8
    static let breaststroke: UInt32 = 0x300024D0
    static let swimmingEnd: UInt32 = 0x300024D1
    static let flutterKick: UInt32 = 0x300024D2
    static let holdBreaststroke: UInt32 = 0x300024D3
    static let holdSwimmingEnd: UInt32 = 0x300024D4
    static let holdFlutterKick: UInt32 = 0x300024D5
    static let waterShellSwimming: UInt32 = 0x300024D6
    static let waterThrow: UInt32 = 0x300024E0
    static let waterPunch: UInt32 = 0x300024E1
    static let waterPlunge: UInt32 = 0x300022E2
    static let caughtInWhirlpool: UInt32 = 0x300222E3
    static let metalWaterStanding: UInt32 = 0x080042F0
    static let holdMetalWaterStanding: UInt32 = 0x080042F1
    static let metalWaterWalking: UInt32 = 0x000044F2
    static let holdMetalWaterWalking: UInt32 = 0x000044F3
    static let metalWaterFalling: UInt32 = 0x000042F4
    static let holdMetalWaterFalling: UInt32 = 0x000042F5
    static let metalWaterFallLand: UInt32 = 0x000042F6
    static let holdMetalWaterFallLand: UInt32 = 0x000042F7
    static let holdMetalWaterJump: UInt32 = 0x000044F9
    static let metalWaterJumpLand: UInt32 = 0x000044FA
    static let holdMetalWaterJumpLand: UInt32 = 0x000044FB
