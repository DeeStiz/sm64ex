# SM64 Modern Full Swift Twin — M33mu Handoff

## Scope

M33mu adds `bhvMrBlizzardSnowball` as a Swift projectile owner. It preserves
parent-held admission, throw-distance launch math, forward/gravity motion,
ground/water deletion, 30×30 hitbox, and white-particle/sand-sound intent.

## Evidence

- Focused Swift/C Mr Blizzard Snowball contract matches at
  `0x6153d13d64702c49`.
- Aggregate dispatch proves launch and delete routing; behavior manifest,
...
- The full verifier completed with `verify_exit=0` in
  `/tmp/sm64-modern-m33mu-full-verify.log`: the complete matrix/build passed,
...
- Manifest: 534 rows, 465 Swift-owned, 69 explicit C adapters,
  fingerprint `0x1af2a780287b2dc9`.
