# SM64 Modern Full Swift Twin — M33mm Handoff

## Scope

M33mm adds `bhvUnusedPoundablePlatform` as a Swift surface owner. It preserves
the authored 1.02 scale, Mario ground-pound admission, mist/triangle break
particle intents, collision-model loading, and deletion after timer 7.

## Evidence

- Focused Swift/C Unused Poundable Platform contract matches at
  `0x961f8e9cf67ce60b`.
- Aggregate dispatch proves ground-pound admission and break-particle output;
...
- The full verifier completed with `verify_exit=0` in
  `/tmp/sm64-modern-m33mm-full-verify.log`: the complete matrix/build passed,
...
- Manifest: 534 rows, 456 Swift-owned, 78 explicit C adapters,
  fingerprint `0xdd43b710433b642b`.
