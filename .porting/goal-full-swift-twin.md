...
| M13: Mario core and interactions | Swift Mario initialization, terrain, health/caps, interactions, hitboxes, effects, and held objects match C. | In progress — M13a save-backed state initialization and M13b health/cap mutation (poison gas, swimming/snow, counters, clamps, near-drowning intent) pass Swift/C fingerprints; action execution, interactions, hitboxes, effects, and held-object behavior remain |
