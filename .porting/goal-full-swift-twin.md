...
| M17: Progression actors | Stars, coins, lives, caps, switches, doors, warps, cannons, checkpoints, and secrets match C. | In progress — M17a progression schemas/reducer, M17b C-compatible SaveFile codec/recovery, and M17c coin-score age/MainMenuData codec pass strict Swift/C fingerprints; actor behaviors, EEPROM endian/I/O, durable atomic writes, dialog/camera/audio delivery, and level-specific reward routes remain |
