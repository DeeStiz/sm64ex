...
M30n is the latest validated bounded Goddard/Mario-face live-route oracle slice. Swift now
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   replays the Mario-normal record through Swift's live schema-4 oracle. Next
   execute every Goddard route across front-end, gameplay, cutscene, and
   ending shards, compare texture/material/camera records, and only then
   consider a face-renderer authority cutover.
