...
M30k is the latest validated bounded Goddard/Mario-face graph/resource slice. Swift now
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   C↔Swift fingerprint admission gate. Next emit a render-ready face packet
   that joins composition transforms to those resource IDs, compare
   route-specific records, reproduce camera orientation and all cutscene
   overrides, and wire the render packet through front-end, gameplay,
