...
M30e is the latest validated bounded Goddard/Mario-face value slice. Swift now
...
focused contract is `script/test_mario_face_resource_manifest.sh`. This
remains a bounded manifest/resource-selection boundary: full 820/166
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   mouth/eyelid/eyebrow/mustache/ear/nose/hat channel composition, and M30e's
   source manifest into a content-pack-ready payload inventory. Then resolve
   face mesh/material/lighting resources through the content pack, reproduce
   camera orientation and all cutscene overrides, and wire the render packet
   through front-end, gameplay, cutscene, and ending shards before any
