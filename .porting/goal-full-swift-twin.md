...
M22au is the latest validated gameplay slice layered on M34a/M33f/M18am; M34a
...
delivery while the source explosion identity remains intentionally owned by
the generic explosion route because it aliases that canonical identity;
collision, camera/audio, and presentation consumers remain typed external
seams. Its strict Swift/C forty-one-route fingerprint is
