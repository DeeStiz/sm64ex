...
| M16: Camera system | Legacy/better camera, cutscene camera, shake, collision, transitions, and negative-coordinate behavior match C. | In progress — M16a camera math/C-button boundary passes strict Swift/C fingerprint; camera state/mode transitions, collision ownership, shake/FOV, cutscene camera, and negative-coordinate whole-mode coverage remain |
