...
| M12: Gameplay input core | Swift input normalization, edges, intended movement, geometry input, timers, and rumble match C. | In progress — M12a controller, M12b Mario button/joystick, and M12c geometry-input contracts pass; floor-angle/terrain classification, focus/demo semantics, camera input, rumble trace integration, dynamic partition-backed queries, and production runtime wiring remain |
