...
| M17: Progression actors | Stars, coins, lives, caps, switches, doors, warps, cannons, checkpoints, and secrets match C. | In progress — M17a progression schemas/reducer, M17b C-compatible SaveFile codec/recovery, M17c coin-score age/MainMenuData codec, M17d red-coin/cap-switch/level-reward actor routes, and M17e owner-thread atomic bundle/recovery plus route lifetime pass strict Swift/C fingerprints; object ownership, EEPROM endian/I/O, durable platform error telemetry, dialog/camera/audio delivery, and level-specific reward routes remain |
