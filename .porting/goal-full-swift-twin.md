...
| M14: Stationary and moving actions | All reachable stationary and moving Mario actions match exact state/effect traces. | In progress — M14a common cancel decisions, M14b grounded-speed kernel, M14c four-quarter ground-step boundary, M14d walk animation/audio state machine, and M14e idle/crouch action bodies pass strict Swift/C fingerprints; stationary/walking integration, wall push/sidle, punch, slide, and full stationary/moving body coverage remain |
