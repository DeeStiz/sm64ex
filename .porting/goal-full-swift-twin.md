...
| M18: Common enemies | Common enemy and projectile families match C across every reachable course. | In progress — M18a Goomba copied-POD size/properties and walk/attack/jump shadow pass the independent Swift/C fingerprint, the 103-script matrix, and native Debug build; live object-list callback wiring, collision/effect delivery, spawner behavior, and remaining enemy/projectile families remain |
