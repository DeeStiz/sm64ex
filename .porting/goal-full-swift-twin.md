...
M30f is the latest validated bounded Goddard/Mario-face value slice. Swift now
...
`script/test_mario_face_resource_manifest_codec.sh`. This remains a bounded
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   source manifest into a content-pack-ready payload inventory, and M30f's
   `MFRM` codec into the actual pack section. Then resolve face
   mesh/material/lighting resources through the content pack, reproduce camera
   orientation and all cutscene overrides, and wire the render packet through
   front-end, gameplay, cutscene, and ending shards before any face-renderer
   authority cutover.
