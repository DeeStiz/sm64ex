...
| M23: Save system | Swift save parsing, mutation, checksums, atomic persistence, recovery, and bidirectional C compatibility pass. | In progress — M23a–M23h cover repair/upgrade, queries, owner-thread copy/erase, pure mutators, runtime dirty/admission integration, normalized-image replay, mutation-event payloads, restart-selector metadata, and durable replay artifacts; options and complete C↔Swift authority closure remain |
