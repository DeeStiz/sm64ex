...
| M14: Stationary and moving actions | All reachable stationary and moving Mario actions match exact state/effect traces. | In progress — M14a common cancel decisions, M14b grounded-speed kernel, and M14c four-quarter ground-step boundary pass strict Swift/C fingerprints; animation, movement-body integration, punch, slide, and full stationary/moving body coverage remain |
