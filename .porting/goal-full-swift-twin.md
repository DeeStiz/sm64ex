...
| M14: Stationary and moving actions | All reachable stationary and moving Mario actions match exact state/effect traces. | In progress — M14a common idle/crouching/start-crouching cancel decisions pass strict Swift/C fingerprint; grounded step, animation, movement, punch, slide, and full stationary/moving body coverage remain |
