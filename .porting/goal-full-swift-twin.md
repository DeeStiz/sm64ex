...
| M16: Camera system | Legacy/better camera, cutscene camera, shake, collision, transitions, and negative-coordinate behavior match C. | In progress — M16a camera math, M16b selection/mode-transition/HUD state, M16c height/focus/radial geometry, M16d collision/height-approach, M16e behind-Mario control, M16f C-up/shake/FOV intent, M16g C-up exit-search, M16h linear transition, M16i wall-avoidance, and M16j data-driven mode callbacks pass strict Swift/C fingerprints; covered-Mario status-3 routing, fixed/parallel/boss/spiral/water/behind/C-up callback bodies, cutscene camera, and negative-coordinate whole-mode coverage remain |
