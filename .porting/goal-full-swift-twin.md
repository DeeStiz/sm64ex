...
| M13: Mario core and interactions | Swift Mario initialization, terrain, health/caps, interactions, hitboxes, effects, and held objects match C. | In progress — M13a initialization, M13b health mutation, M13c cap timers/state transitions, and M13d terrain snapshots pass strict Swift/C fingerprints; action execution, interaction dispatch, hitboxes, effects, and held-object behavior remain |
