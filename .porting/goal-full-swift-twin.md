...
| M16: Camera system | Legacy/better camera, cutscene camera, shake, collision, transitions, and negative-coordinate behavior match C. | In progress — M16a camera math, M16b selection/mode-transition/HUD state, and M16c height/focus/radial geometry boundaries pass strict Swift/C fingerprints; surface-query ownership, wall resolution, bounded-camera callbacks, shake/FOV, cutscene camera, and negative-coordinate whole-mode coverage remain |
