...
| M10: Surface and collision | Swift surface loading and floor/ceiling/wall/water queries match all levels. | In progress — M10a floor/ceiling/water surface world and C fixture contract pass; wall collision, surface loading/partitioning, ray queries, and production-level differential closure remain |
