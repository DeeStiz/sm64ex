...
| M15: Airborne/submerged/automatic actions | All reachable air, water, climbing, hanging, cannon, and automatic actions match C. | In progress — M15a shared `common_air_action_step` and M15b jump/double/triple/backflip/freefall/held-air callers pass strict Swift/C fingerprints; non-shell airborne callers, water/submerged actions, climbing/hanging/cannon actions, and owner-thread dispatch remain |
