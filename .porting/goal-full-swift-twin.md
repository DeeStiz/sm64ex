...
| M18: Common enemies | Common enemy and projectile families match C across every reachable course. | In progress — M18a Goomba copied-POD shadow, M18b owner-thread scheduler/spawner bridge, and M18c interaction-bit/attack-table admission pass fingerprints \`0x0b1058cb88f78d06\` and \`0x7b7a91e29b3e1003\`, the 104-script matrix, and native Debug build; full collision resolution and remaining enemy/projectile families remain |
