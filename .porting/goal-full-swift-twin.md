...
M18ah is the latest validated checkpoint: Bullet Bill's transient smoke child
deletion is delivered through the owner-thread effect router in the independent
Swift/C fingerprint `0x98814f6acf3e0025`, and the strict focused contract, full
131-script matrix, and regenerated native Debug build pass. M18ag remains the
preceding validated water-bomb router-adoption checkpoint. M0–M17 local scopes remain complete
