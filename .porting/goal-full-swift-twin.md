...
M18u is the latest validated checkpoint: the Mr. I eye/body/particle bridge
emits the independent Swift/C fingerprint `0x18b1a7bddb65a836`, the strict
focused contract passes, the full 122-script matrix passes, and the generated
native Debug build succeeds. M0–M17 local scopes remain complete for their
bounded contracts; M18 is still open for the remaining common-enemy/projectile
