...
M30g is the latest validated bounded Goddard/Mario-face value slice. Swift now
...
manifest/resource-selection boundary: full 820/166
residency, expression composition, graph/resource IDs, lighting, camera
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   `MFRM` codec into the actual pack section, and M30g's source-only pack
   reload into a repeatable content gate. Then resolve face mesh/material/
   lighting resources through the content pack, reproduce camera orientation
   and all cutscene overrides, and wire the render packet through front-end,
   gameplay, cutscene, and ending shards before any face-renderer authority
   cutover.
