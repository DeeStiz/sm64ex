...
| M18: Common enemies | Common enemy and projectile families match C across every reachable course. | In progress — M18a Goomba copied-POD shadow plus M18b owner-thread scheduler, collision/attack input, callback-ordered effects, triplet spawning, parent dead flags, and respawn requests pass fingerprints \`0x0b1058cb88f78d06\` and \`0x4555e82cf78e277f\`, the 104-script matrix, and native Debug build; broad collision dispatch and remaining enemy/projectile families remain |
