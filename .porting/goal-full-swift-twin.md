...
M18aa is the latest validated checkpoint: the Chain Chomp parent/segment
bridge emits the independent Swift/C fingerprint `0x89d7ec70d95560c8`, the
strict focused contract passes, the full 128-script matrix passes, and the generated native
