...
M30i is the latest validated bounded Goddard/Mario-face value slice. Swift now
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   compares decoded transforms across wrap and invalid-bank routes. Next
   resolve graph/resource IDs and mesh/material/lighting resources through the
   content pack, compare route-specific records, reproduce camera orientation
   and all cutscene overrides, and wire the
