...
| M14: Stationary and moving actions | All reachable stationary and moving Mario actions match exact state/effect traces. | In progress — M14a common idle/crouching/start-crouching cancel decisions and M14b grounded-speed kernel pass strict Swift/C fingerprints; grounded step, animation, movement-body integration, punch, slide, and full stationary/moving body coverage remain |
