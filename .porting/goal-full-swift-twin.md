...
| M16: Camera system | Legacy/better camera, cutscene camera, shake, collision, transitions, and negative-coordinate behavior match C. | In progress — M16a camera math/C-button boundary and M16b selection/mode-transition/HUD state boundary pass strict Swift/C fingerprints; camera-mode geometry, collision ownership, shake/FOV, cutscene camera, and negative-coordinate whole-mode coverage remain |
