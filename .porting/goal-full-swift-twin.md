...
| M12: Gameplay input core | Swift input normalization, edges, intended movement, geometry input, timers, and rumble match C. | In progress — M12a controller, M12b Mario button/joystick, M12c wall/floor/water/gas composition, and M12d floor-angle/slipperiness/terrain-sound contracts pass; focus/demo semantics, camera input, rumble trace integration, dynamic partition-backed queries, and production runtime wiring remain |
