...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   buffer through the transform-aware shader. Next bind source texture/material
   semantics and compare a complete Mario-normal C draw list before any
   authority cutover. Route IDs
