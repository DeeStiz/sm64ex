...
M30h is the latest validated bounded Goddard/Mario-face value slice. Swift now
...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   inventory into a hash/size admission gate. Next import the full bytes into
   an isolated content-pack resource policy, drive every expression channel
