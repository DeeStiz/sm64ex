...
M18ab is the latest validated checkpoint: the Chain Chomp wooden-post/gate
release bridge emits the independent Swift/C fingerprint `0xdd959e6ce61c03bd`,
the strict focused contract passes, the full 129-script matrix passes, and the
regenerated native Debug build succeeds. M0–M17 local scopes remain complete
