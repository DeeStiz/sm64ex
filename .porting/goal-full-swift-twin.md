...
| M10: Surface and collision | Swift surface loading and floor/ceiling/wall/water queries match all levels. | In progress — M10a floor/ceiling/water and M10b wall/ray C fixture contracts pass; surface loading/partitioning, dynamic lifecycle, poison-gas/edge cases, and production-level differential closure remain |
