...
8. **M30 Goddard/Mario face.** M30a captures the pointer-free Goddard
   ...
   divergence detection. Next drive those route IDs from real front-end,
   gameplay, cutscene, and ending entry points, compare texture/material/
   camera records and route ordering, then bind the matched resources to a
   Metal 4 face encoder before considering a face-renderer authority cutover.
