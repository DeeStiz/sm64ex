# SM64 Modern Full Swift Twin — M33de Handoff
...
state, penguin-proximity deletion, opacity, and the 16-frame lifetime.

## Validation

- `script/test_strong_wind_particle.sh` passes with matching Swift/C fingerprint
  `0x5b4c3a0189f542ff`.
- `script/test_behavior_dispatch_bridge.sh` verifies both identities, movement,
  opacity, and route identity with the existing dispatch fingerprint
  `0x681ceb2358bf2e21`.
