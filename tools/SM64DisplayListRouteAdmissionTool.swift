...
/// Admits the source-bound wooden-door display-list route into a new,
...
/// gates.
@main
struct SM64DisplayListRouteAdmissionTool {
    ...
    private static let routeShardID: UInt64 = 0x00ca_b93b_5dd9_4425
    private static let routeInputSeed: UInt64 = 0x101f_5dd7_c1ad_86c9
    private static let routeSaveSeed: UInt64 = 0x2593_8342_95e6_8816
    private static let routeEvent: UInt64 = 0xd1
    ...
    private static let sourceIdentity: UInt64 = 0x3f42_61ff_4f87_1037
    private static let ownerIdentity: UInt64 = 0x9f2e_e294_c18a_11b4
    private static let routeLayer: UInt32 = 1
    private static let routeWordCount: UInt32 = 4
    private static let routeTriangleCount: UInt32 = 4
    private static let routeFlags: UInt32 = 3
    private static let routeResourceID: UInt32 = 0x0301_4658
    private static let routePacketFingerprint: UInt64 = 0xf30f_054d_96e3_5dc9
    private static let routeWords: [UInt32] = [
        0x0100_8010, 0x0301_4658,
        0x0600_0204, 0x0000_0602,
        0x0608_0a0c, 0x0008_0c0e,
        0xdf00_0000, 0x0000_0000,
    ]
    private static let routeResources: [UInt32] = [routeResourceID, 0, 0, 0]
    private static let routeResourceFingerprint: UInt64 = 0xbd86_1ae0_bda8_71ad
    ...
    private enum ToolError: Error, CustomStringConvertible {
        ...
        var description: String {
            ...
            case let .wrongManifestRow(reason): return "display-list manifest row mismatch: \(reason)"
    ...
    static func main() {
        do {
            ...
            FileHandle.standardError.write(Data(("sm64-display-list-route-admit: \(error)\n").utf8))
            exit(2)
        }
    }
    ...
    private static func run(arguments: [String]) throws {
        ...
        print(
            "SM64 display-list route isolated admission passed "
                + "shard=\(formatID(routeShardID)) identity=door_seg3_dl_03014A20 "
                + "source=actors/door/model.inc.c records=2 ticks=1,2 domain=11 kind=7 schema=4 "
    ...
    private static func resolveTarget(_ rows: [ManifestRow]) throws -> ManifestRow {
        ...
        guard shard.domain == "display_list",
              shard.identity == "door_seg3_dl_03014A20",
              shard.source == "actors/door/model.inc.c",
    ...
    private static func validateCanonicalHeader(_ configuration: SM64OracleTraceConfiguration, label: String) throws {
        let expected = SM64OracleTraceConfiguration(
            regionCode: 0x5553,
            mode: .record,
            buildFingerprint: hashString("sm64-modern-display-list-route-build-v1"),
            contentFingerprint: hashString("actors/door/model.inc.c|door_seg3_dl_03014A20|render_packet"),
            ...
            initialSaveFingerprint: hashString("save=empty-us-slot-0;seed=0x2593834295e68816"),
    ...
    private static func requireMarkers(_ options: Options) throws {
        for marker in [
            "c_display_list_route_recorded shard=0x00cab93b5dd94425 records=2 ticks=1,2",
            "display_list_route_debug oracle_end=0 result_status=0 records=2 invocations=2 matches=2 failures=0",
            "display_list_route_owner_fence=1 pointer_free_packet=1",
        ] { try requireMarker(options.debugLog, marker) }
        for marker in [
            "swift_display_list_route_recorded shard=0xcab93b5dd94425 records=2 ticks=1,2 words=4 triangles=4",
            "display_list_pairing_audit admitted=1 c_records=2 swift_records=2 blockers= first_divergence=none",
            "display_list_pairing_tamper_rejected=1",
